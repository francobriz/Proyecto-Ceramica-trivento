...
app.use(
  expSession({
    secret: "muro-de-cristal,gran-cuerno,ondas-infernales,otra-dimension,plasma-relampago,seim-samsara,cien-dragones,aguja-escarlata,trueno-atomico,excalibur,ejecucion-aurora,rosa-sangrienta",
  })
);
...
app.post("/cargarCv",upload.single("archivo"), (req,res) => {
  const cargarDatos = {
    ...
    fs.renameSync(req.file.path,`cliente/cvs/curriculum-${req.body.nombre}.${req.file.mimetype.split("/")[1]}`);
